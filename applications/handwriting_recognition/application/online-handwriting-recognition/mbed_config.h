...
#define MBED_CONF_CORDIO_LL_PHY_CODED_SUPPORT                                   1                                                                                                // set by library:cordio-ll[MCU_NRF52840]
...
#define MBED_CONF_CORDIO_NORDIC_LL_HCI_DRIVER_BUFFER_SIZE                       16056                                                                                            // set by library:cordio-nordic-ll[MCU_NRF52840]
...
#define MBED_CONF_RTOS_MAIN_THREAD_STACK_SIZE                                   (8*1024)                                                                                         // set by application[*]
